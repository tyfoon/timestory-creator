...
serve(async (req) => {
  ...
  try {
    ...
    // Use word-based estimate - ElevenLabs speaks at ~2.8-3.2 words/sec
    ...
    console.log(`ElevenLabs speech generated. Estimated: ${estimatedDurationSeconds.toFixed(2)}s (${wordCount} words, ${audioBuffer.byteLength} bytes)`);
